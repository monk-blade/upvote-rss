...
class WebpageAnalyzer {
  ...
  public function getSummary() {
    ...
    if (empty($result['summary'])) {
      ...
      $this->log->warning('Summary for the URL ' . $this->url . ' could not be generated after ' . $this->summary_tries . $tries_text);
      $this->savePropertiesToCache();
      return '';
    }
    ...
    $this->log->info("Summary for URL $this->url generated by $this->summary_provider model $this->summary_model in $time_text");
